...
/*   Updated: 2025/01/20 18:37:06 by bszikora         ###   ########.fr       */
/*                                                                            */
/******************************************************************************/
...
static void update_env_var(t_env_var *current, const char *key, const char *value)
{
    size_t len;
...
static void create_new_env_var(t_env_var **env_vars, const char *key, const char *value)
{
    t_env_var *new_var;
    size_t len;
